...
[`src/exchange/kraken.ts` L64–L87](../src/exchange/kraken.ts#L64-L87) spawns the CLI as a subprocess:
...
Then use `KrakenMCPClient` in [`src/exchange/kraken.ts`](../src/exchange/kraken.ts):
